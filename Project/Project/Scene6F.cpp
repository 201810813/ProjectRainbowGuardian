...
void Scene6F::makeLayout() {
    ...
    WriteManager::GetInstance()->AddLine(FMessageParam(LAYOUT_TYPE::STORY, "😭 이곳은 남색 슬픔의 층입니다.", false, 1, TEXT_COLOR_TYPE::BLUE_INENSITY));
    WriteManager::GetInstance()->AddLine(FMessageParam(LAYOUT_TYPE::STORY, "👻 눈물 망령의 대성통곡이 귀를 찌릅니다.", false, 2, TEXT_COLOR_TYPE::WHITE));
