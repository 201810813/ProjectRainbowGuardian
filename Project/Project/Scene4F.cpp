...
void Scene4F::setupBattleRoom() {
    ...
    WriteManager::GetInstance()->AddLine(FMessageParam(LAYOUT_TYPE::STORY, "🌱 이곳은 녹색 생명의 층입니다.", false, 0, TEXT_COLOR_TYPE::GREEN));
    WriteManager::GetInstance()->AddLine(FMessageParam(LAYOUT_TYPE::STORY, "☠️ 독 덩굴 괴물이 나타났습니다.", false, 1, TEXT_COLOR_TYPE::WHITE));
...
void Scene4F::setupAltarRoom() {
    // Map Layout
    WriteManager::GetInstance()->MakeLayout(LAYOUT_TYPE::MAP, 104, 2, 9, 9);
    WriteManager::GetInstance()->AddLine(FMessageParam(LAYOUT_TYPE::MAP, "04 [⛲]", false, 5, TEXT_COLOR_TYPE::ORANGE));
